...
Definition _COOChunk_append : ident := 90%positive.
Definition _COOChunk_concat : ident := 94%positive.
Definition _COOChunk_free : ident := 87%positive.
Definition _COOChunk_freeAll : ident := 89%positive.
Definition _COOChunk_freeNodes : ident := 88%positive.
Definition _COOChunk_malloc : ident := 86%positive.
Definition _COOChunk_print : ident := 103%positive.
Definition _COOChunk_push : ident := 91%positive.
Definition _COOChunk_toCSR : ident := 99%positive.
Definition _COOItem_free : ident := 175%positive.
Definition _COOItem_malloc : ident := 112%positive.
Definition _CSR_dense : ident := 186%positive.
Definition _CSR_free : ident := 182%positive.
Definition _CSR_malloc : ident := 98%positive.
...
Definition _Matrix_free : ident := 178%positive.
Definition _Matrix_malloc : ident := 177%positive.
Definition _Matrix_toCSR : ident := 181%positive.
...
Definition ___stringlit_1 : ident := 100%positive.
Definition ___stringlit_2 : ident := 101%positive.
Definition ___stringlit_3 : ident := 102%positive.
Definition _addQueue : ident := 171%positive.
Definition _ai : ident := 201%positive.
Definition _an : ident := 121%positive.
Definition _bi : ident := 202%positive.
Definition _bn : ident := 122%positive.
Definition _chunk : ident := 85%positive.
Definition _chunkA : ident := 132%positive.
Definition _chunkB : ident := 133%positive.
Definition _chunkLen : ident := 136%positive.
Definition _chunkLen__1 : ident := 137%positive.
Definition _chunks : ident := 158%positive.
Definition _col : ident := 6%positive.
Definition _colHead : ident := 105%positive.
Definition _cols : ident := 10%positive.
Definition _comp : ident := 117%positive.
Definition _condense : ident := 167%positive.
Definition _count : ident := 20%positive.
Definition _csr : ident := 95%positive.
Definition _currA : ident := 141%positive.
Definition _currA__1 : ident := 146%positive.
Definition _currB : ident := 142%positive.
Definition _currB__1 : ident := 147%positive.
Definition _currComp : ident := 127%positive.
Definition _currComp__1 : ident := 145%positive.
Definition _currLen : ident := 159%positive.
Definition _direction : ident := 140%positive.
Definition _elimZero : ident := 129%positive.
Definition _flattenByMergeTree : ident := 162%positive.
Definition _free : ident := 80%positive.
Definition _gemm_sparch : ident := 199%positive.
Definition _head : ident := 17%positive.
Definition _heap : ident := 22%positive.
Definition _height : ident := 1%positive.
Definition _i : ident := 97%positive.
Definition _i__1 : ident := 109%positive.
Definition _i__2 : ident := 138%positive.
Definition _i__3 : ident := 143%positive.
Definition _i__4 : ident := 144%positive.
Definition _idx : ident := 166%positive.
Definition _index : ident := 179%positive.
Definition _item : ident := 13%positive.
Definition _iterLen : ident := 200%positive.
Definition _j : ident := 123%positive.
Definition _j__1 : ident := 124%positive.
Definition _j__2 : ident := 139%positive.
Definition _k : ident := 203%positive.
Definition _kInit : ident := 194%positive.
Definition _lastDirection : ident := 131%positive.
Definition _left : ident := 92%positive.
Definition _leftChunk : ident := 190%positive.
Definition _leftIdx : ident := 172%positive.
Definition _leftLen : ident := 189%positive.
Definition _leftVal : ident := 106%positive.
Definition _len : ident := 16%positive.
Definition _lenA : ident := 119%positive.
Definition _lenB : ident := 120%positive.
Definition _lenLeft : ident := 134%positive.
Definition _lenRight : ident := 135%positive.
Definition _lenVal : ident := 9%positive.
Definition _li : ident := 152%positive.
Definition _litem : ident := 154%positive.
Definition _main : ident := 205%positive.
Definition _malloc : ident := 79%positive.
Definition _mat : ident := 183%positive.
Definition _matA : ident := 187%positive.
Definition _matB : ident := 188%positive.
Definition _matmul : ident := 204%positive.
Definition _matrix : ident := 176%positive.
Definition _maxBound : ident := 116%positive.
Definition _maxChunk : ident := 148%positive.
Definition _maxCount : ident := 21%positive.
Definition _merge : ident := 157%positive.
Definition _mergeHier : ident := 151%positive.
Definition _mergeLow : ident := 130%positive.
Definition _mergeTop : ident := 149%positive.
Definition _mergedIdx : ident := 193%positive.
Definition _mergedVal : ident := 196%positive.
Definition _merger : ident := 160%positive.
Definition _minBound : ident := 115%positive.
Definition _mm : ident := 198%positive.
Definition _multVal : ident := 191%positive.
Definition _newItem : ident := 111%positive.
Definition _next : ident := 15%positive.
Definition _nextLen : ident := 161%positive.
Definition _node : ident := 81%positive.
Definition _offset : ident := 180%positive.
Definition _outLen : ident := 163%positive.
Definition _outerProd : ident := 113%positive.
Definition _parent : ident := 170%positive.
Definition _popQueue : ident := 174%positive.
Definition _posCmp : ident := 114%positive.
Definition _posX : ident := 125%positive.
Definition _posY : ident := 126%positive.
Definition _pq : ident := 192%positive.
Definition _printf : ident := 78%positive.
Definition _queue : ident := 169%positive.
Definition _result : ident := 104%positive.
Definition _ri : ident := 153%positive.
Definition _right : ident := 93%positive.
Definition _rightIdx : ident := 173%positive.
Definition _rightRowEnd : ident := 108%positive.
Definition _rightRowStart : ident := 107%positive.
Definition _rightVal : ident := 110%positive.
Definition _ritem : ident := 155%positive.
Definition _row : ident := 5%positive.
Definition _rowCnt : ident := 164%positive.
Definition _rowCnt__1 : ident := 165%positive.
Definition _rowEnd : ident := 185%positive.
Definition _rowId : ident := 96%positive.
Definition _rowStart : ident := 184%positive.
Definition _rows : ident := 11%positive.
Definition _spgemm_sparch : ident := 197%positive.
Definition _swapHeap : ident := 168%positive.
Definition _tail : ident := 18%positive.
Definition _tailItem : ident := 156%positive.
Definition _temp : ident := 118%positive.
Definition _tempLen : ident := 128%positive.
Definition _treeItems : ident := 195%positive.
Definition _value : ident := 7%positive.
Definition _values : ident := 3%positive.
Definition _width : ident := 2%positive.
Definition _zeroCount : ident := 150%positive.
Definition _t'1 : ident := 206%positive.
Definition _t'10 : ident := 215%positive.
Definition _t'11 : ident := 216%positive.
Definition _t'12 : ident := 217%positive.
Definition _t'13 : ident := 218%positive.
Definition _t'14 : ident := 219%positive.
Definition _t'15 : ident := 220%positive.
Definition _t'16 : ident := 221%positive.
Definition _t'17 : ident := 222%positive.
Definition _t'18 : ident := 223%positive.
Definition _t'19 : ident := 224%positive.
Definition _t'2 : ident := 207%positive.
Definition _t'20 : ident := 225%positive.
Definition _t'21 : ident := 226%positive.
Definition _t'22 : ident := 227%positive.
Definition _t'23 : ident := 228%positive.
Definition _t'24 : ident := 229%positive.
Definition _t'25 : ident := 230%positive.
Definition _t'26 : ident := 231%positive.
Definition _t'27 : ident := 232%positive.
Definition _t'28 : ident := 233%positive.
Definition _t'29 : ident := 234%positive.
Definition _t'3 : ident := 208%positive.
Definition _t'30 : ident := 235%positive.
Definition _t'31 : ident := 236%positive.
Definition _t'32 : ident := 237%positive.
Definition _t'33 : ident := 238%positive.
Definition _t'34 : ident := 239%positive.
Definition _t'35 : ident := 240%positive.
Definition _t'36 : ident := 241%positive.
Definition _t'37 : ident := 242%positive.
Definition _t'38 : ident := 243%positive.
Definition _t'39 : ident := 244%positive.
Definition _t'4 : ident := 209%positive.
Definition _t'40 : ident := 245%positive.
Definition _t'41 : ident := 246%positive.
Definition _t'42 : ident := 247%positive.
Definition _t'43 : ident := 248%positive.
Definition _t'44 : ident := 249%positive.
Definition _t'45 : ident := 250%positive.
Definition _t'46 : ident := 251%positive.
Definition _t'47 : ident := 252%positive.
Definition _t'48 : ident := 253%positive.
Definition _t'49 : ident := 254%positive.
Definition _t'5 : ident := 210%positive.
Definition _t'50 : ident := 255%positive.
Definition _t'51 : ident := 256%positive.
Definition _t'52 : ident := 257%positive.
Definition _t'53 : ident := 258%positive.
Definition _t'54 : ident := 259%positive.
Definition _t'55 : ident := 260%positive.
Definition _t'6 : ident := 211%positive.
Definition _t'7 : ident := 212%positive.
Definition _t'8 : ident := 213%positive.
Definition _t'9 : ident := 214%positive.
...
Definition f_mergeLow := {|
  ...
  fn_params := ((_left, (tptr (Tstruct __COOChunk noattr))) ::
                ...
                (_result, (tptr (Tstruct __COOChunk noattr))) :: nil);
  fn_vars := ((_comp, (tarray (tarray tint 3) 3)) ::
                                  ...
                                  (Sassign
                                    (Ederef
                                      (Ebinop Oadd
                                        (Ederef
                                          (Ebinop Oadd
                                            (Evar _comp (tarray (tarray tint 3) 3))
                                            (Etempvar _i tuint)
                                            (tptr (tarray tint 3)))
                                          (tarray tint 3))
                              ...
                              (Ebinop Oadd
                                (Ederef
                                  (Ebinop Oadd
                                    (Evar _comp (tarray (tarray tint 3) 3))
                                    (Etempvar _i tuint)
                                    (tptr (tarray tint 3))) (tarray tint 3))
...
Definition f_mergeTop := {|
  ...
  fn_vars := ((_comp, (tarray (tarray tint 2) 2)) ::
              (_chunkA, (tarray (Tstruct __COOChunk noattr) 2)) ::
              (_chunkB, (tarray (Tstruct __COOChunk noattr) 2)) ::
  ...
  fn_temps := ((_lenLeft, tuint) :: (_lenRight, tuint) :: (_lenA, tuint) ::
               ...
               (_posX, tuint) :: (_posY, tuint) :: (_currComp, tint) ::
               (_currA, (tptr (Tstruct __COOChunk noattr))) ::
               (_currB, (tptr (Tstruct __COOChunk noattr))) ::
               (_i__3, tuint) :: (_i__4, tuint) :: (_currComp__1, tint) ::
               (_currA__1, (tptr (Tstruct __COOChunk noattr))) ::
               (_currB__1, (tptr (Tstruct __COOChunk noattr))) ::
               ...
               (_t'55, (tptr (Tstruct __COOItem noattr))) ::
               (_t'54, (tptr (Tstruct __LLNode noattr))) ::
               (_t'53, (tptr (Tstruct __COOItem noattr))) ::
               (_t'52, (tptr (Tstruct __LLNode noattr))) :: (_t'51, tuint) ::
               (_t'50, (tptr (Tstruct __COOItem noattr))) ::
               (_t'49, (tptr (Tstruct __LLNode noattr))) :: (_t'48, tuint) ::
               (_t'47, (tptr (Tstruct __COOItem noattr))) ::
               (_t'46, (tptr (Tstruct __LLNode noattr))) :: (_t'45, tuint) ::
               (_t'44, (tptr (Tstruct __COOItem noattr))) ::
               (_t'43, (tptr (Tstruct __LLNode noattr))) :: (_t'42, tuint) ::
               (_t'41, (tptr (Tstruct __COOItem noattr))) ::
               (_t'40, (tptr (Tstruct __LLNode noattr))) :: (_t'39, tuint) ::
               (_t'38, tuint) :: (_t'37, tuint) ::
               (_t'36, (tptr (Tstruct __COOItem noattr))) ::
               ...
               (_t'19, tuint) :: (_t'18, (tptr (Tstruct __LLNode noattr))) ::
               (_t'17, tuint) ::
               (_t'16, (tptr (Tstruct __COOItem noattr))) ::
               (_t'15, (tptr (Tstruct __LLNode noattr))) :: (_t'14, tuint) ::
               (_t'13, (tptr (Tstruct __COOItem noattr))) ::
               (_t'12, (tptr (Tstruct __LLNode noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sassign
    (Ederef
      (Ebinop Oadd
        (Ederef
          (Ebinop Oadd (Evar _comp (tarray (tarray tint 2) 2))
            (Econst_int (Int.repr 0) tint) (tptr (tarray tint 2)))
          (tarray tint 2)) (Econst_int (Int.repr 0) tint) (tptr tint)) tint)
    (Econst_int (Int.repr 0) tint))
  (Ssequence
    (Sassign
      (Ederef
      ...
      (Sassign
        (Ederef
          (Ebinop Oadd
            (Ederef
              (Ebinop Oadd (Evar _comp (tarray (tarray tint 2) 2))
                (Econst_int (Int.repr 1) tint) (tptr (tarray tint 2)))
              (tarray tint 2)) (Econst_int (Int.repr 0) tint) (tptr tint))
          tint) (Econst_int (Int.repr 0) tint))
      (Ssequence
        (Sassign
          (Ederef
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Ssequence
              (Sset _lenA
                (Ebinop Odiv
                  (Ebinop Oadd (Etempvar _lenLeft tuint)
                    (Ebinop Osub (Econst_int (Int.repr 2) tint)
                      (Econst_int (Int.repr 1) tint) tint) tuint)
                  (Econst_int (Int.repr 2) tint) tuint))
              (Ssequence
                (Ssequence
                  (Sifthenelse (Ebinop Ogt (Etempvar _lenA tuint)
                                 (Econst_int (Int.repr 2) tint) tint)
                    (Sset _t'1 (Ecast (Econst_int (Int.repr 2) tint) tuint))
                    (Sset _t'1 (Ecast (Etempvar _lenA tuint) tuint)))
                  (Sset _lenA (Etempvar _t'1 tuint)))
                (Ssequence
                  (Sset _lenB
                    (Ebinop Odiv
                      (Ebinop Oadd (Etempvar _lenRight tuint)
                        (Ebinop Osub (Econst_int (Int.repr 2) tint)
                          (Econst_int (Int.repr 1) tint) tint) tuint)
                      (Econst_int (Int.repr 2) tint) tuint))
                  (Ssequence
                    (Ssequence
                      (Sifthenelse (Ebinop Ogt (Etempvar _lenB tuint)
                                     (Econst_int (Int.repr 2) tint) tint)
                        (Sset _t'2
                          (Ecast (Econst_int (Int.repr 2) tint) tuint))
                        (Sset _t'2 (Ecast (Etempvar _lenB tuint) tuint)))
                      (Sset _lenB (Etempvar _t'2 tuint)))
                    (Ssequence
                      (Sset _head
                        (Efield
                          (Ederef
                        ...
                        (Ssequence
                          ...
                          (Sloop
                            (Ssequence
                              ...
                              (Ssequence
                                (Sset _chunkLen
                                  (Ebinop Osub (Etempvar _lenLeft tuint)
                                ...
                                (Ssequence
                                  (Ssequence
                                    (Sifthenelse (Ebinop Olt
                                                   ...
                                                   tint)
                                      (Sset _t'3
                                        (Ecast (Etempvar _chunkLen tuint)
                                          tuint))
                                      (Sset _t'3
                                        (Ecast (Econst_int (Int.repr 2) tint)
                                          tuint)))
                                    (Sset _chunkLen (Etempvar _t'3 tuint)))
                                  (Ssequence
                                    (Sassign
                                      (Efield
                                        (Ederef
                                        ...
                                        tuint) (Etempvar _chunkLen tuint))
                                    (Ssequence
                                      (Sassign
                                        (Efield
                                          (Ederef
                            ...
                            (Ssequence
                              ...
                              (Sloop
                                (Ssequence
                                  ...
                                  (Ssequence
                                    (Sset _chunkLen__1
                                      (Ebinop Osub (Etempvar _lenRight tuint)
                                              ...
                                              (Ssequence
                                                ...
                                                (Ssequence
                                                  (Sset _t'53
                                                    (Efield
                                                      (Ederef
                                                        (Etempvar _t'52 (tptr (Tstruct __LLNode noattr)))
                                                        (Tstruct __LLNode noattr))
                                                      _item
                                                      (tptr (Tstruct __COOItem noattr))))
                                                  (Ssequence
                                                    ...
                                                    (Ssequence
                                                      (Sset _t'55
                                                        (Efield
                                                          (Ederef
                                                            (Etempvar _t'54 (tptr (Tstruct __LLNode noattr)))
                                                            (Tstruct __LLNode noattr))
                                                          _item
                                                          (tptr (Tstruct __COOItem noattr))))
                                                      (Scall (Some _t'5)
                                                        ...
                                                        (Tfunction
                                                          (Tcons
                                                            ...
                                                            (Tcons
                                                              ...
                                                              Tnil)) tint
                                                          cc_default))
                                                        ((Etempvar _t'53 (tptr (Tstruct __COOItem noattr))) ::
                                                         (Etempvar _t'55 (tptr (Tstruct __COOItem noattr))) ::
                                                         nil))))))
                                              (Sifthenelse (Ebinop Ogt
                                                             (Etempvar _t'5 tint)
                                                             (Econst_int (Int.repr 0) tint)
                                            ...
                                            (Sassign
                                              (Ederef
                                                (Ebinop Oadd
                                                  (Ederef
                                                    (Ebinop Oadd
                                                      (Evar _comp (tarray (tarray tint 2) 2))
                                                      (Etempvar _i__2 tuint)
                                                      (tptr (tarray tint 2)))
                                                    (tarray tint 2))
                                                  (Etempvar _j__2 tuint)
                                              ...
                                              (Etempvar _t'6 tint))))
                                        (Sset _j__2
                                          (Ebinop Oadd (Etempvar _j__2 tuint)
                                            (Econst_int (Int.repr 1) tint)
                                            tuint)))))
                                  (Sset _i__2
                                            ...
                                            (Ssequence
                                              ...
                                              (Ssequence
                                                (Sset _t'50
                                                  (Efield
                                                    (Ederef
                                                      (Etempvar _t'49 (tptr (Tstruct __LLNode noattr)))
                                                      (Tstruct __LLNode noattr))
                                                    _item
                                                    (tptr (Tstruct __COOItem noattr))))
                                                (Ssequence
                                                  (Sset _t'51
                                                    (Efield
                                                      (Ederef
                                                        (Etempvar _t'50 (tptr (Tstruct __COOItem noattr)))
                                                        (Tstruct __COOItem noattr))
                                                      _row tuint))
                                                  (Sassign
                                                    (Efield
                                              ...
                                              (Ssequence
                                                ...
                                                (Ssequence
                                                  (Sset _t'47
                                                    (Efield
                                                      (Ederef
                                                        (Etempvar _t'46 (tptr (Tstruct __LLNode noattr)))
                                                        (Tstruct __LLNode noattr))
                                                      _item
                                                      (tptr (Tstruct __COOItem noattr))))
                                                  (Ssequence
                                                    (Sset _t'48
                                                      (Efield
                                                        (Ederef
                                                          (Etempvar _t'47 (tptr (Tstruct __COOItem noattr)))
                                                          (Tstruct __COOItem noattr))
                                                        _col tuint))
                                                    (Sassign
                                                      (Efield
                                              ...
                                              (Ssequence
                                                ...
                                                (Ssequence
                                                  (Sset _t'44
                                                    (Efield
                                                      (Ederef
                                                        (Etempvar _t'43 (tptr (Tstruct __LLNode noattr)))
                                                        (Tstruct __LLNode noattr))
                                                      _item
                                                      (tptr (Tstruct __COOItem noattr))))
                                                  (Ssequence
                                                    (Sset _t'45
                                                      (Efield
                                                        (Ederef
                                                          (Etempvar _t'44 (tptr (Tstruct __COOItem noattr)))
                                                          (Tstruct __COOItem noattr))
                                                        _row tuint))
                                                    (Sassign
                                                      (Efield
                                                    ...
                                                    (Ssequence
                                                      ...
                                                      (Ssequence
                                                        ...
                                                        (Ssequence
                                                          ...
                                                          (Ssequence
                                                            (Sifthenelse (Etempvar _currComp__1 tint)
                                                              (Ssequence
                                                                (Sset _posY
                                                                  (Ebinop Oadd
                                                                    (Etempvar _posY tuint)
...
Definition f_elimZero := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((_chunk, (tptr (Tstruct __COOChunk noattr))) :: nil);
  fn_vars := ((_zeroCount, (tarray tuint 4)) ::
              (_temp, (Tstruct __COOChunk noattr)) :: nil);
  fn_temps := ((_len, tuint) :: (_node, (tptr (Tstruct __LLNode noattr))) ::
               (_next, (tptr (Tstruct __LLNode noattr))) :: (_i, tuint) ::
               (_t'5, tfloat) :: (_t'4, (tptr (Tstruct __COOItem noattr))) ::
               (_t'3, tuint) :: (_t'2, (tptr (Tstruct __LLNode noattr))) ::
               (_t'1, (tptr (Tstruct __LLNode noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sassign (Efield (Evar _temp (Tstruct __COOChunk noattr)) _len tuint)
        ...
        (Ssequence
          ...
          (Ssequence
                          ...
                          (Sset _t'5
                            (Efield
                              (Ederef
                                (Etempvar _t'4 (tptr (Tstruct __COOItem noattr)))
                                (Tstruct __COOItem noattr)) _value tfloat))
                          (Sifthenelse (Ebinop Oeq (Etempvar _t'5 tfloat)
            ...
            (Ssequence
              (Ssequence
                (Sset _t'3
                  (Efield (Evar _temp (Tstruct __COOChunk noattr)) _len
                    tuint))
                (Sassign
                  (Efield
                    (Ederef
                  ...
                  (Sassign
                    (Efield
                      (Ederef
                        ...
                        (Tstruct __COOChunk noattr)) _tail
                      (tptr (Tstruct __LLNode noattr)))
                    (Etempvar _t'1 (tptr (Tstruct __LLNode noattr)))))))))))))
|}.
...
Definition f_mergeHier := {|
  ...
  fn_temps := ((_direction, tint) :: (_t'5, tint) :: (_t'4, tint) ::
               ...
               (_t'18, (tptr (Tstruct __LLNode noattr))) ::
               (_t'17, (tptr (Tstruct __LLNode noattr))) :: (_t'16, tuint) ::
               (_t'15, (tptr (Tstruct __LLNode noattr))) ::
               (_t'14, (tptr (Tstruct __LLNode noattr))) ::
               (_t'13, (tptr (Tstruct __LLNode noattr))) :: (_t'12, tuint) ::
               (_t'11, (tptr (Tstruct __LLNode noattr))) ::
               (_t'10, (tptr (Tstruct __LLNode noattr))) :: (_t'9, tuint) ::
               (_t'8, tuint) :: (_t'7, (tptr (Tstruct __LLNode noattr))) ::
                  ...
                  (Ssequence
                    ...
                    (Sifthenelse (Ebinop Ogt (Etempvar _t'8 tuint)
                      ...
                      (Ssequence
                        ...
                        (Sset _t'4
                          (Ecast
                            (Ebinop Ogt (Etempvar _t'9 tuint)
